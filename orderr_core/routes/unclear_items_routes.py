...
#   from orderr_core.services.template_parser import VALID_PRODUCT_NAMES
#   import json
...
def get_unclear_items(db: Session = Depends(get_db), _=Depends(require_auth)):
    ...
    """
    from orderr_core.services.order_service import get_unclear_orders
    import json
...
def resolve_unclear_item(
    ...
    from orderr_core.services.template_parser import VALID_PRODUCT_NAMES, PRODUCT_DEFINITIONS
