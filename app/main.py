...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=12, minute=11, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=12, minute=12, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=12, minute=13, timezone="Asia/Kolkata"),
