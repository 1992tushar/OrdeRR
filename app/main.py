...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=19, minute=58, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=19, minute=59, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=19, minute=56, timezone="Asia/Kolkata"),
