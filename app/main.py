...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=13, minute=2, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=13, minute=4, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=13, minute=5, timezone="Asia/Kolkata"),
