...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=13, minute=02, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=13, minute=04, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=13, minute=05, timezone="Asia/Kolkata"),
