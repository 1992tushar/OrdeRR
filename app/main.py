...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=12, minute=42, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=12, minute=43, timezone="Asia/Kolkata"),
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=12, minute=44, timezone="Asia/Kolkata"),
